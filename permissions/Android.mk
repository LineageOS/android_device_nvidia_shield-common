...
include $(CLEAR_VARS)
LOCAL_MODULE               := privapp-permissions-nvidia.xml
LOCAL_SRC_FILES            := privapp-permissions-nvidia.xml
LOCAL_MODULE_TAGS          := optional
LOCAL_MODULE_CLASS         := ETC
LOCAL_VENDOR_MODULE        := true
LOCAL_MODULE_RELATIVE_PATH := permissions
...
include $(CLEAR_VARS)
LOCAL_MODULE               := privapp-permissions-nvidia-system.xml
LOCAL_SRC_FILES            := privapp-permissions-nvidia-system.xml
LOCAL_MODULE_TAGS          := optional
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_RELATIVE_PATH := permissions
include $(BUILD_PREBUILT)
